...
view.when(function() {
	...
	identifyParams24k.layerIds = [2584,2477,2496,2515,2457,2435,2407,2386,2372,2334,2316,2259,2237,2210,2193,2167,2157,2117,2116,2084,2026,1994,1948,1910,1898,1882,1867,1850,1817,1802,1989,1776,1757,1738,1720,1702,1677,1664,1647,1630,1614,1598,1581,1564,1548,1532,1515,1498,1483,1472,1441]		//default is ALL if ommited, must omit as layer response time is too slow for unit descriptions.
    //identifyParams.layerDefinitions  = [layerDefs[#] = "STATE_NAME='Kansas' and POP2007>25000"];		//#must correspond to the layerId you are running the SQL exp on
...
var executeIdentifyTask500k = function (event) {
    console.log("looking for 500k units");
    ...
    queryTask.execute(query).then(function(results){
      console.log(results);
        ...
        var getPubSQLData = function (mapid) {
                ...
                }).when(function () { //end esriRequest.when
